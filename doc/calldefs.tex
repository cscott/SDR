...
\begin{figure}
\displaythree
{ \dancer 1e \cr \dancer 2w \cr \dancer 3e \cr \dancer 4w \cr
  \dancer 5e \cr \dancer 6w \cr \dancer 7e \cr \dancer 8w }
{\ctablebox{Starting \\ formation}}
{ & \dancer 1e \cr & \dancer 2w \cr
 \dancer 6e & & \dancer 4e \cr
 \dancer 5w & & \dancer 3w \cr
  & \dancer 7e \cr & \dancer 8w }
{\call{Centers ah so}}
{ \dancer 2n & \dancer 1s \cr
  \dancer 4s & \dancer 6n \cr
  \dancer 3s & \dancer 5n \cr
  \dancer 8n & \dancer 7s }
...
\begin{figure}
\displaythree
{          & \dancer 1n & \gdancer 2n & \cr
\gdancer 3n & \dancer 4s & \dancer 5n & \gdancer 6s \cr
           & \gdancer 7s & \dancer 8s }%
{Before}
{          & \gdancer 2s & \dancer 1s & \cr
\dancer 4n & \gdancer 3s & \gdancer 6n & \dancer 5s \cr
           & \dancer 8n & \gdancer 7n }%
{Halfway}
{          & \gdancer 2s & \dancer 1s & \cr
\dancer 5n & \gdancer 3s & \gdancer 6n & \dancer 4s \cr
           & \dancer 8n & \gdancer 7n }%
{After}
...
\begin{figure}
\displaythree
{ \dancer 1n & \dancer 3s & \gdancer 2n & \gdancer 4s \cr
  \gdancer 5n & \gdancer 7s & \dancer 6n & \dancer 8s }%
{Before}
{ \dancer 3n & \dancer 1s & \gdancer 2n & \gdancer 4s \cr
  \gdancer 5n & \gdancer 7s & \dancer 8n & \dancer 6s }%
{Halfway}
{ \dancer 3n & \gdancer 2s & \dancer 1n & \gdancer 4s \cr
  \gdancer 5n & \dancer 8s & \gdancer 7n & \dancer 6s }%
{After}
...
\begin{figure}
\displayone
{ \dancer 1n & \gdancer 2n & \gdancer 4s & \dancer 3s \cr
  \dancer 6n & \gdancer 5n & \gdancer 7s & \dancer 8s }%
{}
