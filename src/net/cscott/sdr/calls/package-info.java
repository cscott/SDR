 ...
 *  (Opt (From 'FACING COUPLES (If (Expr and (Expr greater '1 1/2 '0) (Expr not (Expr greater '1 1/2 '1))) (Seq (Apply (Expr _fractional '1 1/2 (Expr _in '2 'pull by)))))) (From 'FACING COUPLES (If (Expr greater '1 1/2 '1) (Seq (Part false (Seq (Apply (Expr and (Expr _in '2 '_sq_thru_part) (Expr left (Expr square thru (Expr _subtract num '1 1/2 '1)))))))))))
 *
