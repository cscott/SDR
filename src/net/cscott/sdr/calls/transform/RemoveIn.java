 ...
 *  (In (Expr _multiply num '1/2 '6) (Opt (From 'ANY (Seq (Part 'INDIVISIBLE '1 (Seq (Apply (Expr _maybe circle adjust '_mixed touch)))) (Part 'DIVISIBLE '3 (In (Expr _multiply num '1/3 '6) (Opt (From 'RH MINIWAVE (Seq (Prim 1, 1, none, 1, SASHAY_FINISH))))))))))
 *  js> def = RemoveIn.removeIn(ds, def)
 *  (Opt (From 'ANY (In '3 (Seq (Part 'INDIVISIBLE '1 (Seq (Apply (Expr _maybe circle adjust '_mixed touch)))) (Part 'DIVISIBLE '3 (In (Expr _multiply num '1/3 '6) (Opt (From 'RH MINIWAVE (Seq (Prim 1, 1, none, 1, SASHAY_FINISH))))))))))
 *  js> def = RemoveIn.removeIn(ds, def.children.get(0).child)
 *  (Seq (Part 'INDIVISIBLE '1 (Seq (Apply (Expr _in '3/4 (Expr _maybe circle adjust '_mixed touch))))) (Part 'DIVISIBLE '3 (Opt (From 'RH MINIWAVE (In '2 1/4 (Seq (Prim 1, 1, none, 1, SASHAY_FINISH)))))))
