...
// @@startwalker
/** {@link Fractional} walks a Call AST and returns a call tree which
 * is n/m of the call.  Calls can only be divided at SEQ( (PART)+ ),
 * and only iff all of those parts are divisible.
 */
class Fractional extends Transformer;
